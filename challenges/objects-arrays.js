...
const universities = [];
graduates.map(students => {
  universities.push(students.university)
...
// let unisWithUni = [];
// unisWithUni = graduates.filter(function (students) {
//   if (students.university.search("Uni" === true)) {
...
const populationTotal =
  zooAnimals.reduce((acc, animals) => acc + animals.population, 0)
